...
LOAD_MODEL = True
PRE_TRAINED_MODEL_PATH = R'D:\Projects\HackTrick24\image_models\DenseEncoder_DenseDecoder_0.042_2020-07-23_02_08_27.dat'

decoder = decoders.DenseDecoder(data_depth, hidden_size).to(device)
critic = critics.BasicCritic(hidden_size).to(device)
